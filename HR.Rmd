...
```{r}
# plot.new()
# png(filename="/Users/mike/play/HR-kaggle/hr-scatter.png", res=300, width = 3000, height = 3000)
...
legend(x=0.93, y=1.16, c("Stay", "Leave"), col=my_colors, pch=c(3,4), horiz=TRUE)
#dev.off()
```
