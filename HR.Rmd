...
P-values (and optionally confidence intervals) for all pairs are calculated with the following formula. Correlations not passing the significance test (_p_<0.01) will be marked with an 'X' in the matrix.
